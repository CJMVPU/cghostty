...
pub const entries: []const Entry = entries: {
    ...
    for (raw_entries, 0..) |raw, i| {
        ...
        result[i] = .{
            .key = code_to_key.get(raw[2]) orelse .unidentified,
            .usb = raw[0],
            .code = raw[2],
            .native = raw[1],
        };
...
/// macOS projection of the Chromium data set: USB HID usage, native keycode, DOM code.
const RawEntry = struct { u32, u32, []const u8 };
...
const raw_entries: []const RawEntry = &.{
    ...
    //   USB      Mac   Code
    .{ 0x000010, 0xffff, "Hyper" },
    .{ 0x000011, 0xffff, "Super" },
    .{ 0x000012, 0xffff, "Fn" },
    .{ 0x000013, 0xffff, "FnLock" },
    .{ 0x000014, 0xffff, "Suspend" },
    .{ 0x000015, 0xffff, "Resume" },
    .{ 0x000016, 0xffff, "Turbo" },
    ...
    //   USB      Mac   Code
    .{ 0x010082, 0xffff, "Sleep" },
    .{ 0x010083, 0xffff, "WakeUp" },
    .{ 0x0100a9, 0xffff, "" },
    .{ 0x0100b5, 0xffff, "DisplayToggleIntExt" },
    ...
    .{ 0x070002, 0xffff, "" },
    .{ 0x070003, 0xffff, "" },
    .{ 0x070004, 0x0000, "KeyA" },
    .{ 0x070005, 0x000b, "KeyB" },
    .{ 0x070006, 0x0008, "KeyC" },
    .{ 0x070007, 0x0002, "KeyD" },

    .{ 0x070008, 0x000e, "KeyE" },
    .{ 0x070009, 0x0003, "KeyF" },
    .{ 0x07000a, 0x0005, "KeyG" },
    .{ 0x07000b, 0x0004, "KeyH" },
    .{ 0x07000c, 0x0022, "KeyI" },
    .{ 0x07000d, 0x0026, "KeyJ" },
    .{ 0x07000e, 0x0028, "KeyK" },
    .{ 0x07000f, 0x0025, "KeyL" },

    .{ 0x070010, 0x002e, "KeyM" },
    .{ 0x070011, 0x002d, "KeyN" },
    .{ 0x070012, 0x001f, "KeyO" },
    .{ 0x070013, 0x0023, "KeyP" },
    .{ 0x070014, 0x000c, "KeyQ" },
    .{ 0x070015, 0x000f, "KeyR" },
    .{ 0x070016, 0x0001, "KeyS" },
    .{ 0x070017, 0x0011, "KeyT" },

    .{ 0x070018, 0x0020, "KeyU" },
    .{ 0x070019, 0x0009, "KeyV" },
    .{ 0x07001a, 0x000d, "KeyW" },
    .{ 0x07001b, 0x0007, "KeyX" },
    .{ 0x07001c, 0x0010, "KeyY" },
    .{ 0x07001d, 0x0006, "KeyZ" },
    .{ 0x07001e, 0x0012, "Digit1" },
    .{ 0x07001f, 0x0013, "Digit2" },

    .{ 0x070020, 0x0014, "Digit3" },
    .{ 0x070021, 0x0015, "Digit4" },
    .{ 0x070022, 0x0017, "Digit5" },
    .{ 0x070023, 0x0016, "Digit6" },
    .{ 0x070024, 0x001a, "Digit7" },
    .{ 0x070025, 0x001c, "Digit8" },
    .{ 0x070026, 0x0019, "Digit9" },
    .{ 0x070027, 0x001d, "Digit0" },

    .{ 0x070028, 0x0024, "Enter" },
    .{ 0x070029, 0x0035, "Escape" },
    .{ 0x07002a, 0x0033, "Backspace" },
    .{ 0x07002b, 0x0030, "Tab" },
    .{ 0x07002c, 0x0031, "Space" },
    .{ 0x07002d, 0x001b, "Minus" },
    .{ 0x07002e, 0x0018, "Equal" },
    .{ 0x07002f, 0x0021, "BracketLeft" },

    .{ 0x070030, 0x001e, "BracketRight" },
    .{ 0x070031, 0x002a, "Backslash" },
    ...
    .{ 0x070033, 0x0029, "Semicolon" },
    .{ 0x070034, 0x0027, "Quote" },
    .{ 0x070035, 0x0032, "Backquote" },
    .{ 0x070036, 0x002b, "Comma" },
    .{ 0x070037, 0x002f, "Period" },

    .{ 0x070038, 0x002c, "Slash" },
    ...
    .{ 0x070046, 0xffff, "PrintScreen" },
    .{ 0x070047, 0xffff, "ScrollLock" },

    .{ 0x070048, 0xffff, "Pause" },
    ...
    .{ 0x07004c, 0x0075, "Delete" },
    .{ 0x07004d, 0x0077, "End" },
    .{ 0x07004e, 0x0079, "PageDown" },
    .{ 0x07004f, 0x007c, "ArrowRight" },

    .{ 0x070050, 0x007b, "ArrowLeft" },
    .{ 0x070051, 0x007d, "ArrowDown" },
    .{ 0x070052, 0x007e, "ArrowUp" },
    .{ 0x070053, 0x0047, "NumLock" },
    .{ 0x070054, 0x004b, "NumpadDivide" },
    .{ 0x070055, 0x0043, "NumpadMultiply" },
    .{ 0x070056, 0x004e, "NumpadSubtract" },
    .{ 0x070057, 0x0045, "NumpadAdd" },

    .{ 0x070058, 0x004c, "NumpadEnter" },
    .{ 0x070059, 0x0053, "Numpad1" }, // +End
    .{ 0x07005a, 0x0054, "Numpad2" }, // +Down
    .{ 0x07005b, 0x0055, "Numpad3" }, // +PageDown
    .{ 0x07005c, 0x0056, "Numpad4" }, // +Left
    .{ 0x07005d, 0x0057, "Numpad5" },
    .{ 0x07005e, 0x0058, "Numpad6" }, // +Right
    .{ 0x07005f, 0x0059, "Numpad7" }, // +Home
    .{ 0x070060, 0x005b, "Numpad8" }, // +Up
    .{ 0x070061, 0x005c, "Numpad9" }, // +PageUp
    .{ 0x070062, 0x0052, "Numpad0" }, // +Insert
    .{ 0x070063, 0x0041, "NumpadDecimal" }, // +Delete
    // USB#070064 is not present on US keyboard.
    // This key is typically located near LeftShift key.
    // The keycap varies on international keyboards:
    //   Dan: <> Dutch: ][ Ger: <> UK: \|
    .{ 0x070064, 0x000a, "IntlBackslash" },
    // USB#0x070065 Application Menu (next to RWin key) -- see note L2 at top.
    .{ 0x070065, 0x006e, "ContextMenu" },
    .{ 0x070066, 0xffff, "Power" },
    .{ 0x070067, 0x0051, "NumpadEqual" },
    ...
    .{ 0x0c0060, 0xffff, "" },
    .{ 0x0c0061, 0xffff, "" },
    .{ 0x0c006f, 0xffff, "BrightnessUp" },
    .{ 0x0c0070, 0xffff, "BrightnessDown" },
    .{ 0x0c0072, 0xffff, "" },
    .{ 0x0c0073, 0xffff, "" },
    .{ 0x0c0074, 0xffff, "" },
    .{ 0x0c0075, 0xffff, "" },
    ...
    //   USB      Mac   Code
    .{ 0x0c00b0, 0xffff, "MediaPlay" },
    .{ 0x0c00b1, 0xffff, "MediaPause" },
    .{ 0x0c00b2, 0xffff, "MediaRecord" },
    .{ 0x0c00b3, 0xffff, "MediaFastForward" },
    .{ 0x0c00b4, 0xffff, "MediaRewind" },
    .{ 0x0c00b5, 0xffff, "MediaTrackNext" },
    .{ 0x0c00b6, 0xffff, "MediaTrackPrevious" },
    .{ 0x0c00b7, 0xffff, "MediaStop" },
    .{ 0x0c00b8, 0xffff, "Eject" },
    .{ 0x0c00cd, 0xffff, "MediaPlayPause" },
    .{ 0x0c00cf, 0xffff, "" },
    .{ 0x0c00d8, 0xffff, "" },
    .{ 0x0c00d9, 0xffff, "" },
    .{ 0x0c00e5, 0xffff, "" },
    // USB#0c0183: AL Consumer Control Configuration
    .{ 0x0c0183, 0xffff, "MediaSelect" },
    .{ 0x0c0184, 0xffff, "" },
    .{ 0x0c0186, 0xffff, "" },
    // USB#0x0c018a AL_EmailReader
    .{ 0x0c018a, 0xffff, "LaunchMail" },
    ...
    .{ 0x0c0221, 0xffff, "BrowserSearch" },
    // USB#0x0c0223:  AC_Home
    .{ 0x0c0223, 0xffff, "BrowserHome" },
    // USB#0x0c0224:  AC_Back
    .{ 0x0c0224, 0xffff, "BrowserBack" },
    // USB#0x0c0225:  AC_Forward
    .{ 0x0c0225, 0xffff, "BrowserForward" },
    // USB#0x0c0226:  AC_Stop
    .{ 0x0c0226, 0xffff, "BrowserStop" },
    // USB#0x0c0227:  AC_Refresh (Reload)
    .{ 0x0c0227, 0xffff, "BrowserRefresh" },
    // USB#0x0c022a:  AC_Bookmarks (Favorites)
    .{ 0x0c022a, 0xffff, "BrowserFavorites" },
    .{ 0x0c022d, 0xffff, "" },
    .{ 0x0c022e, 0xffff, "" },
    // USB#0x0c0230:  AC Full Screen View
    // USB#0x0c0231:  AC Normal View
    .{ 0x0c0232, 0xffff, "ZoomToggle" },
    // USB#0x0c0279:  AC Redo/Repeat
    .{ 0x0c0279, 0xffff, "" },
    // USB#0x0c0289:  AC_Reply
    .{ 0x0c0289, 0xffff, "MailReply" },
    // USB#0x0c028b:  AC_ForwardMsg (MailForward)
    .{ 0x0c028b, 0xffff, "MailForward" },
    // USB#0x0c028c:  AC_Send
    .{ 0x0c028c, 0xffff, "MailSend" },
    // USB#0x0c029d:  AC Next Keyboard Layout Select
    .{ 0x0c029d, 0xffff, "KeyboardLayoutSelect" },
    .{ 0x0c029f, 0xffff, "ShowAllWindows" },
    .{ 0x0c02a2, 0xffff, "" },
    .{ 0x0c02d0, 0xffff, "" },
};

test "macOS keycodes have unique native mappings" {
    // A native keycode must select exactly one USB/DOM mapping. Also force
    // evaluation of the entire table in core tests, not just library builds.
    for (entries, 0..) |entry, i| {
        if (entry.native == 0xffff) continue;
        for (entries[i + 1 ..]) |other| {
            try std.testing.expect(entry.native != other.native);
        }
    }
}
