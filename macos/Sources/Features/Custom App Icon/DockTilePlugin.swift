...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.cjmvpu.cghostty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.cjmvpu.cghostty")
    #endif
