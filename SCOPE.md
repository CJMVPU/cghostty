...
唯一应用目标：macOS 13+、Apple Silicon arm64。构建入口对 Intel macOS、Linux、Windows、iOS、WASM 等目标明确报错。Xcode 工程及内部 XCFramework 不生成 Universal / x86_64 切片。
...
- Zig 终端核心及其测试；Swift 原生应用和测试；Metal、CoreText、字体解析、Unicode、图片、主题及 shell 集成。
